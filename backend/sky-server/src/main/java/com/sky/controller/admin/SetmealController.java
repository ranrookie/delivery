...
public class SetmealController {
    ...
    public Result<T> addSetmeal(@RequestBody SetmealDTO setmealDTO) {
    ...
    public Result<T> deleteSetmeal(@RequestParam List<Long> ids) {
        log.info("批量删除套餐...");
    ...
    @ApiOperation("修改套餐")
    @CacheEvict(cacheNames = "setmealCache",allEntries = true)
    public Result<T> updateSetmeal(@RequestBody SetmealDTO setmealDTO){
        log.info("修改套餐...");
